...
parser.add_argument('--pretrained_1', type=str, default=
        './',
        help='training loss')
parser.add_argument('--denoise_path', type=str, default="/home/rachel/projects/leo/video_restoration/DFPIR/test/denoise/", help='save path of test noisy images')
parser.add_argument('--derain_path', type=str, default="/home/rachel/projects/leo/video_restoration/DFPIR/test/derain/", help='save path of test raining images')
parser.add_argument('--dehaze_path', type=str, default="/home/rachel/projects/leo/video_restoration/DFPIR/test/dehaze/", help='save path of test hazy images')
parser.add_argument('--deblur_path', type=str, default="/home/rachel/projects/leo/video_restoration/DFPIR/test/deblur/", help='test dataset blur images') 
parser.add_argument('--lowlight_path', type=str, default="/home/rachel/projects/leo/video_restoration/DFPIR/test/delowlight/", help='test dataset lowlight images') 
