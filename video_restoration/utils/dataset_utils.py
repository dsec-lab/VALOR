...
class DeblurTestDataset(Dataset):
    ...
    def _init_input_ids(self):
        self.ids = []
        name_list = os.listdir(self.args.deblur_path)
        self.ids += [self.args.deblur_path + id_ for id_ in name_list]
...
class LOLTestDataset(Dataset):
    ...
    def _init_input_ids(self):
        self.ids = []
        name_list = os.listdir(self.args.lowlight_path)
        self.ids += [self.args.lowlight_path + id_ for id_ in name_list]
